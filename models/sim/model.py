...
from .networks import VAE_Encoder,Decoder_reshape
from .model_bert import ModelForMaskedLM,CustomSparseCategoricalAccuracy,masked_sparse_categorical_crossentropy
...
class GMM_Survival(tf.keras.Model):
    ...
    def call(self, inputs, training=True):
        ...
        dec = self.decoder_reshape(tf.reshape(z_sample,(-1,z_sample.shape[-1])))
