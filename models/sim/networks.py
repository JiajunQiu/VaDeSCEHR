...
class VAE_Encoder(layers.Layer):
    def __init__(self, encoded_size):
        ...
        self.mu = tfkl.Dense(encoded_size, activation=None, kernel_initializer='glorot_uniform')
        self.sigma = tfkl.Dense(encoded_size, activation=None, kernel_initializer='glorot_uniform')
...
class Decoder_reshape(layers.Layer):
    def __init__(self, config):
        ...
        self.dense5 = tfkl.Dense(config['pre_training']['seq_length']*config['pre_training']['hidden_size'])
